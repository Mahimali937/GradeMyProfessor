      ...
      <div>
        ...
        <div id="about">
          <div className="container">
            <h2>GradeMyProfessor Givewaway</h2>
            <p>
            ...
            <p>
                There will be five winners in total. E-gift cards will be sent to the email registered to your GradeMyProfessor account.
            </p>
            ...
            <br/>
            <p>
                Please email any questions to <a href="mailto:admin@grademyprofessor.io">admin@grademyprofessor.io</a>
            </p>
          </div>
        </div>
