...
const TermsOfUse = () => {
  return (
    <div>
      <p>Effective as of January 28, 2025.</p>
      <p>
        By using GradeMyProfessor sites, services, and mobile applications (together,
        GradeMyProfessor), whether as a guest or a registered user, you accept and
        agree to bound by these Terms. Please read these Terms carefully before
        you start to use GradeMyProfessor, as well as the GradeMyProfessor Privacy Policy.
        If you do not agree to these Terms or the GradeMyProfessor Privacy Policy you
        must not access or use GradeMyProfessor.
      </p>
      <h5>Changes to the Terms</h5>
      <p>
        GradeMyProfessor a platform/site owned and operated by Aevue LLC
        (“GradeMyProfessor”, “company”, “we” or “us”). We may revise and update these
        Terms from time to time at our sole discretion. Any changes are
        effective when we post them. Your continued use of GradeMyProfessor following
      ...
      <ul>
        ...
        <li>
          ...
          GradeMyProfessor or interfere with any other person’s use of GradeMyProfessor;
        </li>
        <li>
        ...
        <li>
          to attack GradeMyProfessor via a denial-of-service attack or a distributed
      ...
      <p>
        ...
        provide (&quot;User Content&quot;). You are solely responsible for the
        User Content that you post, upload, link to or otherwise make available
        via the Service. You agree that we are only acting as a passive conduit
        for your online distribution and publication of your User Content. The
        Company, however, reserves the right to remove any User Content from the
        Service at its discretion.
      </p>
      <p>
        You also agree that you will not send, knowingly receive, upload,
      ...
      <ul>
        ...
        <li>
          contains any material which is defamatory, obscene, indecent, abusive,
          offensive, harassing, violent, hateful, inflammatory, or otherwise
          objectionable; promotes sexually explicit or pornographic material,
          violence, or discrimination on any basis, including that based on
        ...
        <li>
          ...
          any civil or criminal liability under laws or regulations;
        </li>
        <li>
        ...
        <li>
          gives the impression that the material emanates from or is endorsed by
          GradeMyProfessor or any other person or entity, if this is not the case.
        </li>
        <li>
      ...
      <p>
        ...
        all User Content. However, at our discretion, we, or the technology we
      ...
      <p>
        ...
        made available through the Service, but not directly by the Company, are
        those of their respective authors, and should not necessarily be relied
        upon. Such authors are solely responsible for such content. The Company
        does not guarantee the accuracy, completeness, or usefulness of any
        information on the Service and neither does the Company adopt nor
        endorse, nor is the Company responsible for the accuracy or reliability
        of any opinion, advice, or statement made by parties other than the
        Company. The Company takes no responsibility and assumes no liability
        for any User Content that you or any other user or third party posts or
        sends over the Service. Under no circumstances will the Company be
        responsible for any loss or damage resulting from anyone's reliance on
        information or other content posted on the Service, or transmitted to
        users.
      </p>
      <p>
        Though the Company strives to enforce these Terms of Use, you may be
        exposed to User Content that is inaccurate or objectionable. The Company
        reserves the right, but has no obligation, to monitor the materials
        posted in the public areas of the service or to limit or deny a user's
        ...
        abusive, harmful or malicious. The Company shall have the right to
        ...
        and/or civil prosecution under the law. If you become aware of misuse of
        our Service, please contact us at{" "}
        <a href={() => false}>admin@grademyprofessor.io</a>.
      </p>
      <h5>LINKS TO OTHER SITES AND/OR MATERIALS</h5>
      <p>
        As part of the Service, the Company may provide you with convenient
        links to third party web site(s) (&quot;Third Party Sites&quot;) as well
        as content or items belonging to or originating from third parties
        (the&quot;Third Party Applications, Software or Content&quot;). These
        links are provided as a courtesy to Service subscribers. The Company has
        ...
        Third Party Applications, Software or Content does not imply approval or
        endorsement thereof by the Company. If you decide to leave the Site and
      ...
      <h5>COPYRIGHT COMPLAINTS AND COPYRIGHT AGENT</h5>
      <p>
        ...
        the same. The Company has adopted and implemented a policy that provides
        for the termination in appropriate circumstances of users of the Service
        who are repeat infringers The Company may terminate access for
      ...
      <p>
        (b) Take-Down Notices. If you are a copyright owner or an agent thereof
        and believe, in good faith, that any materials provided on the Service
        infringe upon your copyrights, you may submit a notification pursuant by
        sending the following information in writing to the Company's designated
        copyright agent at GradeMyProfessor:
      </p>
      <ul>
        ...
        <li>
          ...
          recovered by a single notification, a representative list of such
          works at that site;{" "}
        </li>
        <li>
      ...
      <p></p>
      <p>
        (c) Counter-Notices. If you believe that your User Content that has been
      ...
      <ul>
        ...
        <li>
          A description of the content that has been removed and the location at
          which the content appeared before it was removed;
        </li>
        <li>
        ...
        <li>
          ...
          that you consent to the laws of Maryland and a statement that you will
      ...
      <p>
        ...
        removed content in 10 business days. Unless the copyright owner files an
        action seeking a court order against the content provider, member or
        user, the removed content may (in the Company's discretion) be
      ...
      <p>
        ...
        Content, if applicable, in whole or impart, and in any form, media or
      ...
      <p>
        ...
        rights. Other product and business names that are mentioned on the
      ...
      <p>
        ...
        to <a href={() => false}>admin@grademyprofessor.io</a>.
      </p>
      <p>
        Opting out may prevent you from receiving messages regarding the Company
        or Special Offers.
      </p>
      <h5>WARRANTY</h5>
      <p>
      ...
      <p>
        ...
        AVAILABLE; OR (D) ANY OTHER INTERACTIONS WITH THE COMPANY OR ANY OTHER
        USER OF THE SERVICE, WHETHER BASED ON WARRANTY, CONTRACT, TORT
        (INCLUDING NEGLIGENCE) OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT THE
        COMPANY HAS BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE, AND EVEN IF
      ...
      <p>
        If you have a dispute with one or more users or a merchant of a product
        or service that you review using the Service, you release us (and our
      ...
      <p>
        ...
        notify you of material changes to the terms by posting a notice on our
        ...
        contact and profile information current. Any changes to these Terms or
        waiver of the Company's rights hereunder shall not be valid or effective
        except in a written agreement bearing the physical signature of an
        officer of the Company. No purported waiver or modification of this
        Agreement by the Company via telephonic or email communications shall be
        valid.
      </p>
      <h5>GENERAL TERMS</h5>
      <p>
      ...
      <p>
        ...
        Maryland, without regard to conflict of law provisions.
      </p>
      <p>
        ...
        at any time with or without your consent. You may not assign or delegate
        any rights or obligations under the Terms of Service or Privacy Policy
        without the Company's prior written consent, and any unauthorized
      ...
      <p>
        ...
        POLICY AT{" "}
        <a href="https://grademyprofessor.io/privacy">https://grademyprofessor.io/privacy</a>{" "}
      ...
      <p>
        ...
        communications relating to GradeMyProfessor should be directed to GradeMyProfessor
        via email: <a href={() => false}>admin@grademyprofessor.io</a>
      </p>
    </div>
  );
};
